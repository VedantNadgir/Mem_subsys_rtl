...
class alignas(VL_CACHE_LINE_BYTES) Vtb_sys___024root final {
  public:
    ...
    struct {
        ...
        IData/*31:0*/ __Vi;
        VlWide<7>/*203:0*/ tb_sys__DOT__u_dut__DOT__req_fifo_head_pkt;
    ...
    struct {
        ...
        VlUnpacked<QData/*50:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__3__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<QData/*50:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__2__KET____DOT__u_req_fifo__DOT__fifo_mem;
