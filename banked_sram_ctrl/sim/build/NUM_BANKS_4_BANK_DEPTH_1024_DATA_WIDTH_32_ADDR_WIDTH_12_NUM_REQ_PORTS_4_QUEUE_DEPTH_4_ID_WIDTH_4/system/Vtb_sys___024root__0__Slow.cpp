...
VL_ATTR_COLD void Vtb_sys___024root___stl_sequent__TOP__0(Vtb_sys___024root* vlSelf) {
    ...
    vlSelfRef.tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__grant_pkt 
        = (0x001fffffffffffffULL & ((((QData)((IData)(vlSelfRef.tb_sys__DOT__u_dut__DOT__req_fifo_head_pkt
                                                      [
                                                      (((IData)(0x00000034U) 
...
VL_ATTR_COLD void Vtb_sys___024root___ctor_var_reset(Vtb_sys___024root* vlSelf) {
    ...
    VL_SCOPED_RAND_RESET_W(212, vlSelf->tb_sys__DOT__u_dut__DOT__req_fifo_head_pkt, __VscopeHash, 14502024236414423830ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__grant_pkt = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 8761872740517337633ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__1__KET____DOT__grant_pkt = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 2286217418991733404ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__2__KET____DOT__grant_pkt = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 12972867342616008528ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__3__KET____DOT__grant_pkt = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 2760469503664548858ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__3__KET____DOT__u_scheduler__DOT__pp0_addr = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 17631891127778379038ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__2__KET____DOT__u_scheduler__DOT__pp0_addr = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 5561953471094956959ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__1__KET____DOT__u_scheduler__DOT__pp0_addr = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 2772360731610625463ull);
    ...
    vlSelf->tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__u_scheduler__DOT__pp0_addr = VL_SCOPED_RAND_RESET_I(10, __VscopeHash, 8349446884634259133ull);
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__3__KET____DOT__u_req_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 15341985533325009005ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__2__KET____DOT__u_req_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 17256370966206878656ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__1__KET____DOT__u_req_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 14052935889520420404ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__0__KET____DOT__u_req_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_Q(53, __VscopeHash, 3230797865360903270ull);
    }
    ...
    vlSelf->tb_sys__DOT__u_env__DOT__drv_req_addr = VL_SCOPED_RAND_RESET_Q(48, __VscopeHash, 10022838445535883327ull);
