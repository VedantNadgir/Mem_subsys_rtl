...
class alignas(VL_CACHE_LINE_BYTES) Vtb_sys___024root final {
  public:
    ...
    struct {
        ...
        SData/*15:0*/ tb_sys__DOT__u_env__DOT__drv_req_strobe;
    ...
    struct {
        ...
        SData/*9:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__3__KET____DOT__u_scheduler__DOT__pp0_addr;
        SData/*9:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__2__KET____DOT__u_scheduler__DOT__pp0_addr;
        SData/*9:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__1__KET____DOT__u_scheduler__DOT__pp0_addr;
        SData/*9:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__u_scheduler__DOT__pp0_addr;
        QData/*47:0*/ tb_sys__DOT__u_env__DOT__drv_req_addr;
        IData/*31:0*/ tb_sys__DOT__csr_rdata;
        VlWide<4>/*127:0*/ tb_sys__DOT__u_dut__DOT__mux_rsp_data;
        ...
        VlWide<4>/*127:0*/ tb_sys__DOT__u_env__DOT__drv_req_data;
        ...
        IData/*31:0*/ __Vi;
        VlWide<7>/*211:0*/ tb_sys__DOT__u_dut__DOT__req_fifo_head_pkt;
        QData/*52:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__grant_pkt;
        QData/*52:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__1__KET____DOT__grant_pkt;
        QData/*52:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__2__KET____DOT__grant_pkt;
        QData/*52:0*/ tb_sys__DOT__u_dut__DOT__g_bank__BRA__3__KET____DOT__grant_pkt;
        VlUnpacked<QData/*36:0*/, 4> tb_sys__DOT__u_dut__DOT__g_rsp_ports__BRA__3__KET____DOT__u_rsp_fifo__DOT__fifo_mem;
        VlUnpacked<QData/*36:0*/, 4> tb_sys__DOT__u_dut__DOT__g_rsp_ports__BRA__2__KET____DOT__u_rsp_fifo__DOT__fifo_mem;
    };
    struct {
        ...
        VlUnpacked<IData/*31:0*/, 1024> tb_sys__DOT__u_dut__DOT__g_bank__BRA__3__KET____DOT__u_sram__DOT__mem;
        VlUnpacked<IData/*31:0*/, 1024> tb_sys__DOT__u_dut__DOT__g_bank__BRA__2__KET____DOT__u_sram__DOT__mem;
        VlUnpacked<IData/*31:0*/, 1024> tb_sys__DOT__u_dut__DOT__g_bank__BRA__1__KET____DOT__u_sram__DOT__mem;
        VlUnpacked<IData/*31:0*/, 1024> tb_sys__DOT__u_dut__DOT__g_bank__BRA__0__KET____DOT__u_sram__DOT__mem;
        VlUnpacked<QData/*52:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__3__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<QData/*52:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__2__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<QData/*52:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__1__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<QData/*52:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__0__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<IData/*31:0*/, 32> tb_sys__DOT__u_dut__DOT__u_perf__DOT__counter;
        VlUnpacked<IData/*31:0*/, 4096> tb_sys__DOT__u_env__DOT__u_sb__DOT__gold_mem;
