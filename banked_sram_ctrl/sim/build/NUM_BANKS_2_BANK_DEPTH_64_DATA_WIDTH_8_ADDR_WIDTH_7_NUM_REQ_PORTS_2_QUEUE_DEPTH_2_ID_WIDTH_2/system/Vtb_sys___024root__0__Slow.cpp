...
VL_ATTR_COLD void Vtb_sys___024root___ctor_var_reset(Vtb_sys___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_rsp_ports__BRA__1__KET____DOT__u_rsp_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 13393449875228266999ull);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->tb_sys__DOT__u_dut__DOT__g_rsp_ports__BRA__0__KET____DOT__u_rsp_fifo__DOT__fifo_mem[__Vi0] = VL_SCOPED_RAND_RESET_I(11, __VscopeHash, 15537313178400827705ull);
    }
