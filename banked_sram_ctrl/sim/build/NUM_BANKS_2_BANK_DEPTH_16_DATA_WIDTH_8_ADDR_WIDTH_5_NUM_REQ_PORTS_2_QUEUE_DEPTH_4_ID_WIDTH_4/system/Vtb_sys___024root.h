...
class alignas(VL_CACHE_LINE_BYTES) Vtb_sys___024root final {
  public:
    ...
    struct {
        ...
        SData/*9:0*/ tb_sys__DOT__u_dut__DOT__u_rsp_mux__DOT__pp1_id;
        ...
        VlUnpacked<IData/*18:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__1__KET____DOT__u_req_fifo__DOT__fifo_mem;
        VlUnpacked<IData/*18:0*/, 4> tb_sys__DOT__u_dut__DOT__g_req_ports__BRA__0__KET____DOT__u_req_fifo__DOT__fifo_mem;
